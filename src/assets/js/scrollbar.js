		...
		var t,
							...
							'x' !== i.axis &&
								(n.overflowed[0]
									? l[0].height() > l[0].parent().height()
										? T.call(this)
										: (Q(t, s[0].toString(), { dir: 'y', dur: 0, overwrite: 'none' }),
									...
									: (T.call(this),
									  'y' === i.axis
											...
											: 'yx' === i.axis &&
											  n.overflowed[1] &&
											  Q(t, s[1].toString(), { dir: 'x', dur: 0, overwrite: 'none' }))),
								'y' !== i.axis &&
									(n.overflowed[1]
			...
			S = function () {
				...
				if ('none' !== i) {
					...
					'border-box' === l &&
						(s -= t.innerHeight() - t.height() + (t.outerHeight() - t.innerHeight())),
			...
			k = function () {
				...
				if (!n.bindEvents) {
					if (
						(R.call(this), i.contentTouchScroll && D.call(this), E.call(this), i.mouseWheel.enable)
					) {
						var r
						t()
					}
			...
			R = function () {
				...
				p
					.bind(
						'mousedown.' + f + ' touchstart.' + f + ' pointerdown.' + f + ' MSPointerDown.' + f,
						function (o) {
					...
					e(document)
						...
						.add(g)
						.bind(
							'mouseup.' + f + ' touchend.' + f + ' pointerup.' + f + ' MSPointerUp.' + f,
							function (e) {
				...
				function n(e) {
					if (ee(e) && !c && !I(e)[2] && (e.stopImmediatePropagation(), !b || S)) {
						...
						r || f ? (e.preventDefault(), (S = 1)) : ((b = 1), C.addClass('mCS_touch_action')),
							(_ =
								'yx' === B.axis ? [d - o, u - a] : 'x' === B.axis ? [null, u - a] : [d - o, null]),
							(M[0].idleTimer = 250),
				...
				function t(t, a) {
					if ((V(o), !A(o, t.target))) {
						...
						;('y' === d && !n.overflowed[0]) ||
							...
							((g > 0 && 0 !== m) || (0 > g && m !== p) || i.mouseWheel.preventDefault) &&
				...
				function u(e, t, o, a, n) {
					switch (n) {
						...
						case 'easeInOutSmooth':
							return (
								(e /= a / 2), 1 > e ? (o / 2) * e * e + t : (e--, (-o / 2) * (e * (e - 2) - 1) + t)
							)
