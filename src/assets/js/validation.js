	...
	;(e.fn.attr2 = function () {
					...
					if (!x.aborted && !F) {
						...
						if ((M && M.location.href != m.iframeSrc) || T) {
							...
							x.aborted && (a('upload aborted'), (i = null)),
								x.status &&
									(i =
										(x.status >= 200 && x.status < 300) || 304 === x.status ? 'success' : 'error'),
								'success' === i
				...
				;(y = w.clk),
					y &&
						...
						b &&
							...
							'image' == y.type &&
								((m.extraData[b + '.x'] = w.clk_x), (m.extraData[b + '.y'] = w.clk_y))))
				var D = 1,
					k = 2,
			...
			if (
				...
				return !e.isReady && i.s
					? (a('DOM not ready, queuing ajaxForm'),
					  ...
					  this)
					: (a(
							'terminating; zero elements found by selector' + (e.isReady ? '' : ' (DOM not ready)')
					  ),
					  this)
			}
			return n.delegation
		...
		(e.fieldValue = function (t, r) {
			...
			if ('select' == i) {
				...
				if (0 > o) return null
				for (
					var s = [], u = t.options, c = 'select-one' == n, l = c ? o + 1 : u.length, f = c ? o : 0;
					l > f;
					f++
				) {
					var m = u[f]
					if (m.selected) {
						...
						if (
							(d ||
								(d =
									m.attributes && m.attributes.value && !m.attributes.value.specified
										? m.text
										: m.value),
							c)
						)
				...
				return this.each(function () {
					...
					r.test(a) || 'textarea' == n
						...
						? /MSIE/.test(navigator.userAgent)
							...
							: e(this).val('')
						: t &&
						  ((t === !0 && /hidden/.test(a)) || ('string' == typeof t && e(this).is(t))) &&
						  (this.value = '')
				})
			}),
