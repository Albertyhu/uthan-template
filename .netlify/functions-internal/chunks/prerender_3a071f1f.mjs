...
import 'clsx';
import { $ as $$BaseLayout, d as $$PreviewLink, S as SiteData, f as createStaticPathArray, e as $$Index$2, g as RenderPagination$1, D as DOTS, u as usePagination, h as createStaticPathArrayForTagsAndPage, i as createStaticPathArrayForTags, p as phoneNumberToNumeric, j as formatPhoneNumber } from './pages/_page__a15086b9.mjs';
import { p as projects, $ as $$Index$1, S as Shape3, d as data$1 } from './pages/index_94d3129d.mjs';
/* empty css                                   */import { $ as $$ContentWrapper } from './pages/error_7f932b42.mjs';
...
async function getStaticPaths$5() {
  var allPosts = [];
  try {
    allPosts = await Astro$4.glob(/* #__PURE__ */ Object.assign({"../posts/post-1 copy.md": () => import('./pages/post-1 copy_b334e37d.mjs').then(n => n.p),"../posts/post-1.md": () => import('./pages/post-1_663ca99e.mjs'),"../posts/post-3.md": () => import('./pages/post-3_aad20aa0.mjs'),"../posts/post-4.md": () => import('./pages/post-4_52a800f9.mjs'),"../posts/post-6.md": () => import('./pages/post-6_d5dbeca6.mjs'),"../posts/post-7.md": () => import('./pages/post-7_50eeeaba.mjs'),"../posts/this-is-the-7th-blog.md": () => import('./pages/this-is-the-7th-blog_145d2d4b.mjs')}), () => "../posts/*.md");
  } catch (error) {
    console.log(error);
  }
