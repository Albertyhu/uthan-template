...
import 'clsx';
import { S as SiteData, c as ServiceDemo, d as SelectedCategory, A as AllCategories, C as CarouselPosition, T as TestimonialSideDirection, e as $$PreviewLink, R as RecentPostsStore, P as ProjectDemo, a as $$BaseLayout } from './_page__120f820b.mjs';
...
/* empty css                           */import { $ as $$ContentWrapper } from './error_5a762164.mjs';
...
function CounterComponent(props) {
  const { number } = props;
  return /* @__PURE__ */ jsx("div", { className: "count-outer relative block text-4xl text-[70px] leading-none text-white", children: /* @__PURE__ */ jsx(CountUp, { end: number }) });
}
