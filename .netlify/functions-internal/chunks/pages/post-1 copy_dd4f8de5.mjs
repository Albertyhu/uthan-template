...
import { a as $$BaseLayout, f as $$Index$2 } from './_page__c4cc2acb.mjs';
import 'clsx';
/* empty css                                 */import { $ as $$Index$1 } from './index_d896c56e.mjs';
...
const $$MarkdownPostLayout = createComponent(async ($$result, $$props, $$slots) => {
  ...
  var allPosts = [];
  try {
    allPosts = await Astro2.glob(/* #__PURE__ */ Object.assign({"../pages/posts/post-1 copy.md": () => Promise.resolve().then(() => post1_copy),"../pages/posts/post-1.md": () => import('./post-1_e8d7093a.mjs'),"../pages/posts/post-3.md": () => import('./post-3_06d1951e.mjs'),"../pages/posts/post-4.md": () => import('./post-4_626d6c6a.mjs'),"../pages/posts/post-6.md": () => import('./post-6_aa1a9c25.mjs'),"../pages/posts/post-7.md": () => import('./post-7_6956e8bb.mjs'),"../pages/posts/this-is-the-7th-blog.md": () => import('./this-is-the-7th-blog_27974645.mjs')}), () => "../pages/posts/*.md");
  } catch (error) {
