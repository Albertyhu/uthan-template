...
import 'clsx';
import { m as makeURLfriendly, f as formatRecentPostArray, s as setBlogPostImages, $ as $$Index$2 } from './_page__b46c19b7.mjs';
/* empty css                            */import { $ as $$Index$1 } from './artificial-turf_51fe04d1.mjs';
...
const $$MarkdownPostLayout = createComponent(async ($$result, $$props, $$slots) => {
  ...
  var allPosts = [];
  try {
    allPosts = await Astro2.glob(/* #__PURE__ */ Object.assign({"../pages/posts/post-1.md": () => Promise.resolve().then(() => post1),"../pages/posts/post-3.md": () => import('./post-3_f6ebffdd.mjs'),"../pages/posts/post-4.md": () => import('./post-4_3b15ac64.mjs'),"../pages/posts/post-6.md": () => import('./post-6_d67972cc.mjs'),"../pages/posts/post-7.md": () => import('./post-7_29b62b00.mjs'),"../pages/posts/post-8.md": () => import('./post-8_9589f831.mjs'),"../pages/posts/post-9.md": () => import('./post-9_0963acda.mjs')}), () => "../pages/posts/*.md");
  } catch (error) {
