...
import { a as $$BaseLayout, f as $$Index$2 } from './_page__40abfa45.mjs';
import 'clsx';
/* empty css                            */import { $ as $$Index$1 } from './index_cc0d21e1.mjs';
...
const $$MarkdownPostLayout = createComponent(async ($$result, $$props, $$slots) => {
  ...
  var allPosts = [];
  try {
    allPosts = await Astro2.glob(/* #__PURE__ */ Object.assign({"../pages/posts/post-1.md": () => Promise.resolve().then(() => post1),"../pages/posts/post-3.md": () => import('./post-3_ce41c84e.mjs'),"../pages/posts/post-4.md": () => import('./post-4_404c0292.mjs'),"../pages/posts/post-6.md": () => import('./post-6_6d3a45c0.mjs'),"../pages/posts/post-7.md": () => import('./post-7_033ce812.mjs'),"../pages/posts/this-is-the-7th-blog.md": () => import('./this-is-the-7th-blog_287e0c0a.mjs')}), () => "../pages/posts/*.md");
  } catch (error) {
