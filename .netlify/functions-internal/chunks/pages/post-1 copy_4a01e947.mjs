...
import { $ as $$BaseLayout, e as $$Index$2 } from './_page__28fe2195.mjs';
import 'clsx';
/* empty css                                 */import { $ as $$Index$1 } from './index_feb08819.mjs';
...
const $$MarkdownPostLayout = createComponent(async ($$result, $$props, $$slots) => {
  ...
  var allPosts = [];
  try {
    allPosts = await Astro2.glob(/* #__PURE__ */ Object.assign({"../pages/posts/post-1 copy.md": () => Promise.resolve().then(() => post1_copy),"../pages/posts/post-1.md": () => import('./post-1_eee786ce.mjs'),"../pages/posts/post-3.md": () => import('./post-3_9c1c6c0d.mjs'),"../pages/posts/post-4.md": () => import('./post-4_6b40871c.mjs'),"../pages/posts/post-6.md": () => import('./post-6_d579f591.mjs'),"../pages/posts/post-7.md": () => import('./post-7_9c569a65.mjs'),"../pages/posts/this-is-the-7th-blog.md": () => import('./this-is-the-7th-blog_b3c7c815.mjs')}), () => "../pages/posts/*.md");
  } catch (error) {
