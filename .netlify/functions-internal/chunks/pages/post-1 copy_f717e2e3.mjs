...
import { $ as $$BaseLayout, e as $$Index$2 } from './_page__35530602.mjs';
import 'clsx';
/* empty css                                 */import { $ as $$Index$1 } from './index_82b233d9.mjs';
...
const $$MarkdownPostLayout = createComponent(async ($$result, $$props, $$slots) => {
  ...
  var allPosts = [];
  try {
    allPosts = await Astro2.glob(/* #__PURE__ */ Object.assign({"../pages/posts/post-1 copy.md": () => Promise.resolve().then(() => post1_copy),"../pages/posts/post-1.md": () => import('./post-1_d4dbf775.mjs'),"../pages/posts/post-3.md": () => import('./post-3_241f2377.mjs'),"../pages/posts/post-4.md": () => import('./post-4_17a3d21b.mjs'),"../pages/posts/post-6.md": () => import('./post-6_d7d3732a.mjs'),"../pages/posts/post-7.md": () => import('./post-7_0713cf6a.mjs'),"../pages/posts/this-is-the-7th-blog.md": () => import('./this-is-the-7th-blog_032a464d.mjs')}), () => "../pages/posts/*.md");
  } catch (error) {
