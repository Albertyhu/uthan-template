/* empty css                         */import { c as createAstro, a as createComponent, r as renderTemplate, m as maybeRenderHead, b as addAttribute, d as renderComponent, s as spreadAttributes, u as unescapeHTML, F as Fragment$1, e as renderSlot, f as renderHead } from '../astro_c3674c5a.mjs';
import 'clsx';
...
const $$Shape1 = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Shape1;
  return renderTemplate`${maybeRenderHead()}<div class="hidden sm:block absolute left-[0px] bottom-[-22px] w-[181px] h-[25px] object-cover" id="shape-1"><img loading="lazy" decoding="async"${addAttribute(ShapeOne.src, "src")} class="w-full h-full" alt="decorative shape"></div>`;
...
const LinkItem = (props) => {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    subDirectory && subDirectory.length > 0 && /* @__PURE__ */ jsx("div", { className: "subDirectoryDiv subDirectory-closed", ref: subDirRef, children: subDirectory.map((sub, index) => /* @__PURE__ */ jsx(
      ...
      {
        className: "relative flex flex-row items-center justify-around border-t-[1px] border-t-[#686868] py-[10px] pl-[25px] hover:bg-slate-800",
        children: /* @__PURE__ */ jsx("a", { href: sub.url, className: "leader-[24px] relative !my-auto block", children: sub.label })
      },
      `${sub.url}-${index}`
    )) })
  ] });
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Index;
  return renderTemplate(_a$1 || (_a$1 = __template$1(["", '<div class="ScrollTopButton w-[3rem] h-[3rem] rounded-full fixed bottom-[6rem] right-[1rem] z-20 cursor-pointer block w-fit userselect-none transition-all duration-1000 buttonHidden invisible bg-[#2f7955]">', '</div><script>\n    const button = document.getElementById("ScrollTopButton")\n    button?.addEventListener("mousedown", ()=>window.scrollTo({top: 0,left: 0,behavior: "smooth",}))\n<\/script>'])), maybeRenderHead(), renderComponent($$result, "Icon", $$Icon, { "id": "ScrollTopButton", "class": "mx-auto w-[3rem] h-[3rem] userselect-none text-[#dbdbdb]", "name": "ic:sharp-arrow-circle-up" }));
...
const $$BaseLayout = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate(_a || (_a = __template(['<html lang="en"><head><meta charset="utf-8"><link rel="icon" type="image/svg+xml" href="/favicon.png"><meta name="viewport" content="width=device-width"><meta name="generator"', ">", "<title>", "</title>", "</head><body>", "", '<div id="backdrop" class="fixed left-0 top-0 w-full h-full z-[99] bg-[#2f7955] backdrop"></div><div id="SlotWrapper" class="mt-[100px] sm:mt-[185px] [@media(min-width:992px)]:mt-[180px] min-h-[100vh] sm:min-h-[95vh] mb-[10px] flex flex-col flex-grow overflow-x-hidden">', "</div>", "", `<script>
