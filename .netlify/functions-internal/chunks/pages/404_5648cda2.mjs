...
const title = "Natural Patters Landscaping";
...
const owner_name = "Eddy Jackson";
const owner_email = "Eddy@natural-patterns.com";
const address = "Chicago 13";
const city = "Melbourne City";
const state = "FL";
const country = "United States";
const zip = "94511";
const business_email = "info@natural-patterns.com";
...
const $$HeaderLower = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<!-- header-lower -->${maybeRenderHead()}<div id="header-lower" class="header-lower font-[Monserrat] border-b-[1px] border-b-slate-300"><div class="auto-container"><div class="justify-between flex flex-nowrap transition-[height] duration-500" id="header-auto-container"><div class="logo-box p-5 sm:py-[37.5px] sm:px-0 my-auto transition-all duration-500" id="header-logo">${renderComponent($$result, "ShapeOne", $$Shape1, {})}<figure class="logo">${renderComponent($$result, "LogoComponent", $$LogoComponent, {})}</figure></div><div class="menu-area clearfix my-auto"><div id="mobile-nav-toggler" class="mobile-nav-toggler"><i class="icon-bar"></i><i class="icon-bar"></i><i class="icon-bar"></i></div><nav class="main-menu navbar-expand-md navbar-light"><div class="" id="navbarSupportedContent"><ul class="navigation clearfix flex">${menuMap && menuMap.length > 0 && menuMap.map((item) => renderTemplate`${renderComponent($$result, "NavItem", $$NavItem, { ...item })}`)}</ul></div></nav></div><div class="hidden sm:flex relative items-center justify-center"><div class="btn-box"><a href="/contact" class="theme-btn btn-one whitespace-nowrap">Get A Quote</a></div></div></div></div></div>`;
...
export { $$BaseLayout as $, AllCategories as A, BackImg as B, CarouselPosition as C, SiteData as S, TestimonialSideDirection as T, _404 as _, $$ContentWrapper as a, $$Icon as b, SelectedCategory as c, formatPhoneNumber as f, phoneNumberToNumeric as p };
