/* empty css                           */import { c as createAstro, a as createComponent, r as renderTemplate, m as maybeRenderHead, b as addAttribute, d as renderComponent, s as spreadAttributes, u as unescapeHTML, F as Fragment$1, e as renderHead, f as renderSlot } from '../astro_d427acf6.mjs';
import 'clsx';
...
const $$ScrollTopButton = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div class="ScrollTopButton block w-fit userselect-none">${renderComponent($$result, "Icon", $$Icon, { "id": "ScrollTopButton", "class": "mx-auto w-[3rem] h-[3rem] userselect-none", "name": "ic:sharp-arrow-circle-up" })}<p class="whitespace-nowrap mx-auto text-center">Scroll to top</p></div>`;
}, "D:/Astro/uthan-site/src/components/scrollTopButton.astro", void 0);
...
const categories = [...new Set(ProjectDemo.projects.map((project) => project.category))];
...
const $$page = createComponent(async ($$result, $$props, $$slots) => {
  ...
  var imageFiles = {};
  try {
    allPosts = await Astro2.glob(/* #__PURE__ */ Object.assign({"../../../posts/post-1.md": () => import('./post-1_2014a3a5.mjs').then(n => n.p),"../../../posts/post-3.md": () => import('./post-3_d3c99bd6.mjs'),"../../../posts/post-4.md": () => import('./post-4_5151e44e.mjs'),"../../../posts/post-6.md": () => import('./post-6_40cd5e21.mjs'),"../../../posts/post-7.md": () => import('./post-7_4b180f1b.mjs'),"../../../posts/this-is-the-7th-blog.md": () => import('./this-is-the-7th-blog_92050e84.mjs')}), () => "../../../posts/*.md");
  } catch (error) {
    allPosts = [];
  }
  try {
...
export { $$Icon as $, AllCategories as A, CarouselPosition as C, DOTS as D, ProjectDemo as P, RecentPostsStore as R, SiteData as S, TestimonialSideDirection as T, _page_ as _, $$BaseLayout as a, $$LogoComponent as b, ServiceDemo as c, SelectedCategory as d, $$PreviewLink as e, $$Index as f, data as g, createStaticPathArray as h, RenderPagination as i, createStaticPathArrayForTagsAndPage as j, createStaticPathArrayForTags as k, phoneNumberToNumeric as l, formatPhoneNumber as m, projects as p, usePagination as u };
