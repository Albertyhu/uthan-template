...
import { a as $$BaseLayout, f as $$Index$2 } from './_page__120f820b.mjs';
import 'clsx';
/* empty css                            */import { $ as $$Index$1 } from './index_ebea3ace.mjs';
...
const $$MarkdownPostLayout = createComponent(async ($$result, $$props, $$slots) => {
  ...
  var allPosts = [];
  try {
    allPosts = await Astro2.glob(/* #__PURE__ */ Object.assign({"../pages/posts/post-1.md": () => Promise.resolve().then(() => post1),"../pages/posts/post-3.md": () => import('./post-3_d3c99bd6.mjs'),"../pages/posts/post-4.md": () => import('./post-4_5151e44e.mjs'),"../pages/posts/post-6.md": () => import('./post-6_40cd5e21.mjs'),"../pages/posts/post-7.md": () => import('./post-7_4b180f1b.mjs'),"../pages/posts/this-is-the-7th-blog.md": () => import('./this-is-the-7th-blog_92050e84.mjs')}), () => "../pages/posts/*.md");
  } catch (error) {
