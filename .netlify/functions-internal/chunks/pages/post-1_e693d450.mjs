...
import { $ as $$BaseLayout } from './404_d52c293a.mjs';
import 'clsx';
import { m as makeURLfriendly, f as formatRecentPostArray, s as setBlogPostImages, $ as $$Index$2 } from './_page__56169325.mjs';
/* empty css                            */import { $ as $$Index$1 } from './contact_70be9fa8.mjs';
...
const $$MarkdownPostLayout = createComponent(async ($$result, $$props, $$slots) => {
  ...
  var allPosts = [];
  try {
    allPosts = await Astro2.glob(/* #__PURE__ */ Object.assign({"../pages/posts/post-1.md": () => Promise.resolve().then(() => post1),"../pages/posts/post-3.md": () => import('./post-3_3fd4024b.mjs'),"../pages/posts/post-4.md": () => import('./post-4_e824abf1.mjs'),"../pages/posts/post-6.md": () => import('./post-6_041cb4aa.mjs'),"../pages/posts/post-7.md": () => import('./post-7_fdd54820.mjs'),"../pages/posts/post-8.md": () => import('./post-8_31b0fe61.mjs'),"../pages/posts/post-9.md": () => import('./post-9_6980c62a.mjs')}), () => "../pages/posts/*.md");
  } catch (error) {
