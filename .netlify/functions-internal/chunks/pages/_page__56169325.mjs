...
const $$page = createComponent(async ($$result, $$props, $$slots) => {
  ...
  var assetMap = /* @__PURE__ */ new Map();
  try {
    allPosts = await Astro2.glob(/* #__PURE__ */ Object.assign({"../../../posts/post-1.md": () => import('./post-1_e693d450.mjs').then(n => n.p),"../../../posts/post-3.md": () => import('./post-3_3fd4024b.mjs'),"../../../posts/post-4.md": () => import('./post-4_e824abf1.mjs'),"../../../posts/post-6.md": () => import('./post-6_041cb4aa.mjs'),"../../../posts/post-7.md": () => import('./post-7_fdd54820.mjs'),"../../../posts/post-8.md": () => import('./post-8_31b0fe61.mjs'),"../../../posts/post-9.md": () => import('./post-9_6980c62a.mjs')}), () => "../../../posts/*.md");
  } catch (error) {
    allPosts = [];
  }
  try {
