/* empty css                         */import { c as createAstro, a as createComponent, r as renderTemplate, m as maybeRenderHead, b as addAttribute, d as renderComponent, i as defineScriptVars, e as renderSlot, s as spreadAttributes, u as unescapeHTML } from '../astro_32dbe7d3.mjs';
import '@astrojs/internal-helpers/path';
import './image-endpoint_81264b76.mjs';
import 'clsx';
import { $ as $$BaseLayout } from './404_5648cda2.mjs';
import { m as makeURLfriendly, f as formatRecentPostArray, s as setBlogPostImages, $ as $$Index$2 } from './_page__3179a546.mjs';
/* empty css                            */import { $ as $$Index$1 } from './artificial-turf_60faf532.mjs';
...
const $$Taglist = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<ul class="flex flex-row flex-wrap [&>li]:mr-1">${tags.map((item) => renderTemplate`${renderComponent($$result, "TagListItem", $$TagListItem, { "url": `../tags/${makeURLfriendly(item.tag)}/1`, "tag": item.tag })}`)}</ul>`;
...
const $$MarkdownPostLayout = createComponent(async ($$result, $$props, $$slots) => {
  ...
  var allPosts = [];
  try {
    allPosts = await Astro2.glob(/* #__PURE__ */ Object.assign({"../pages/posts/post-1.md": () => Promise.resolve().then(() => post1),"../pages/posts/post-3.md": () => import('./post-3_4c59387e.mjs'),"../pages/posts/post-4.md": () => import('./post-4_073579d1.mjs'),"../pages/posts/post-6.md": () => import('./post-6_409cc3db.mjs'),"../pages/posts/post-7.md": () => import('./post-7_1a89e2e9.mjs'),"../pages/posts/post-8.md": () => import('./post-8_d2a044d1.mjs'),"../pages/posts/post-9.md": () => import('./post-9_88f34176.mjs')}), () => "../pages/posts/*.md");
  } catch (error) {
...
const post1$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
    __proto__: null,
    Content: Content$1,
    compiledContent: compiledContent$1,
    default: Content$1,
...
export { $$MarkdownPostLayout as $, post1 as a, post1$1 as p };
